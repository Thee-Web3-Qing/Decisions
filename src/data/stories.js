...
import jayplaysPremiseCover from '../assets/jayplays-premise.jpg';
...
export const stories = [
  ...
  {
    id: 2,
    title: "Watch the Mint",
    character: "Jayplays",
    author: "QingTheCreator",
    description: "A story about saying something before it's too late. Jayplays, a dev on crypto Twitter, spots a suspicious NFT mint and must decide what to do next. Every choice shapes his reputation, impact, and future in Web3.",
    coverImage: jayplaysPremiseCover,
    difficulty: "Medium",
    ...
    intro: {
      id: "intro",
      paragraphs: [
        { id: "intro_p1", text: "Jayplays wasn't famous. Not even semi-known. Just another dev on crypto Twitter with 162 followers and a habit of watching the chain when things felt off." },
        { id: "intro_p2", text: "One night, a trendy NFT project dropped a mint link. The hype was instant — top influencers, bot comments, FOMO. But something wasn't right." },
        { id: "intro_p3", text: "Jayplays looked closer. The mint address didn't match the one from the audit preview. He hesitated, then tweeted: 'That mint link might be fake. Double check. Could be a scam.' He expected silence. Or maybe a troll reply. Instead — it went viral." }
      ],
      choices: [
        { id: "A1", text: "Delete the tweet and vanish — he's not ready for drama.", nextDecision: "A1" },
        { id: "B1", text: "Double down and start verifying other projects.", nextDecision: "B1" },
        { id: "C1", text: "Reach out to the project team directly and ask for clarity.", nextDecision: "C1" }
      ]
    },
    decisions: [
      {
    ...
    endings: [
      {
        ...
        paragraphs: [
          {
            id: "A1a1a_p1",
            text: "Jayplays didn't chase fame; he just kept building tools and helping others, and his reputation grew organically."
          },
          {
            id: "A1a1a_p2",
            text: "Eventually, other developers began referencing his work, and his tools appeared in various ecosystems."
          },
          {
            id: "A1a1a_p3",
            text: "He never sought recognition, but his impact was felt throughout the Web3 community."
          }
        ],
        requirements: [
          { decisionId: "A1a1", choiceId: "A1a1a" }
      ...
      },
      {
        ...
        paragraphs: [
          {
            id: "A1a1b_p1",
            text: "He sold his tools to a privacy-focused organization that promised to keep them open source."
          },
          {
            id: "A1a1b_p2",
            text: "The sale gave him resources to fund his next project while ensuring his tools would continue to serve the community."
          },
          {
            id: "A1a1b_p3",
            text: "He used the proceeds to start a foundation dedicated to building privacy-first tools for the decentralized web."
      ...
      },
      {
        ...
        paragraphs: [
          {
            id: "A1a1c_p1",
            text: "He walked away from his previous work entirely, leaving it in the hands of the community."
          },
          {
            id: "A1a1c_p2",
            text: "With a clean slate, he started building something completely different — a tool for creators to monetize their work."
          },
          {
            id: "A1a1c_p3",
            text: "This time, he built in public from day one, sharing his process and learning from the community."
          }
        ],
        requirements: [
          { decisionId: "A1a1", choiceId: "A1a1c" }
      ...
      },
      {
        ...
        paragraphs: [
          {
            id: "A1a2a_p1",
            text: "He logged off and disappeared completely, leaving behind only his work and the mystery of his identity."
          },
          {
            id: "A1a2a_p2",
            text: "Years later, people still referenced his tools as defining moments in Web3 development."
          },
          {
            id: "A1a2a_p3",
            text: "Some claimed to have met him in person, but no one could prove it. The legend grew larger than the man."
      ...
      },
      {
        ...
        paragraphs: [
          ...
          {
            id: "A1a2b_p2",
            text: "His writing attracted a following of thinkers, builders, and critics who engaged in deep discussions."
          },
          {
            id: "A1a2b_p3",
            text: "The blog became a platform for exploring ideas that went beyond the hype and focused on deeper questions."
          }
        ],
        requirements: [
          { decisionId: "A1a2", choiceId: "A1a2b" }
      ...
      },
      {
        ...
        paragraphs: [
          {
            id: "A1a2c_p1",
            text: "He turned his experience into a limited-edition zine that explored themes of value, anonymity, and digital art."
          },
          {
            id: "A1a2c_p2",
            text: "The zine became a collector's item, with each copy containing unique elements that made it impossible to replicate."
          },
          {
            id: "A1a2c_p3",
            text: "He continued creating digital art that challenged people's assumptions about what Web3 could be."
          }
        ],
        requirements: [
          { decisionId: "A1a2", choiceId: "A1a2c" }
      ...
      },
      {
        ...
        paragraphs: [
          {
            id: "A1a3a_p1",
            text: "He built a platform that made it easy for creators to design and distribute narrative airdrops."
          },
          {
            id: "A1a3a_p2",
            text: "The platform became popular among artists and creators who wanted to tell stories through blockchain."
          },
          {
            id: "A1a3a_p3",
            text: "He found a new way to combine his technical skills with his love for storytelling and community building."
      ...
      },
      {
        ...
        paragraphs: [
          {
            id: "A1a3b_p1",
            text: "He disappeared again, leaving his work as his final statement on the intersection of art and technology."
          },
          {
            id: "A1a3b_p2",
            text: "His work became legendary, with collectors and artists studying it for years to understand what made it powerful."
          },
          {
            id: "A1a3b_p3",
            text: "His influence lived on through the work of others who were inspired by his approach to digital art."
          }
        ],
        requirements: [
          { decisionId: "A1a3", choiceId: "A1a3b" }
      ...
      },
      {
        ...
        paragraphs: [
          {
            id: "A1a3c_p1",
            text: "He started writing stories based on blockchain data, creating narratives that emerged from on-chain interactions."
          },
          {
            id: "A1a3c_p2",
            text: "His stories became popular among crypto enthusiasts who saw their own journeys reflected in the data."
          },
          {
            id: "A1a3c_p3",
            text: "He pioneered a new genre of blockchain literature that used on-chain data as the foundation for storytelling."
